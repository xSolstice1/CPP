...
public:
    ...
    typedef elemType (*func)(elemType&);
...
private:
    ...
    */
    void InOrder(func f, NodeType<elemType> *p) const;
    ...
    */
    void PreOrder(func f, NodeType<elemType> *p) const;
    ...
    */
    void PostOrder(func f, NodeType<elemType> *p) const;
    ...
    */
    void Insert(BSTNode*& current, elemType insertItem);
...
template <class elemType>
void BST<elemType>::InOrderTraversal(func f) const
{
    InOrder(f, root);
}

template <class elemType>
void BST<elemType>::PreOrderTraversal(func f) const
{
    PreOrder(f, root);
}

template <class elemType>
void BST<elemType>::PostOrderTraversal(func f) const
{
    PostOrder(f, root);
}
...
template <class elemType>
void BST<elemType>::InOrder(func f, NodeType<elemType> *p) const
{
    if (p != nullptr)
    {
        InOrder(f, p->lLink);
...
template <class elemType>
void BST<elemType>::PreOrder(func f, NodeType<elemType> *p) const
{
    if (p != nullptr)
    {
        (f)(p->info);
...
template <class elemType>
void BST<elemType>::PostOrder(func f, NodeType<elemType> *p) const
{
    if (p != nullptr)
    {
        PostOrder(f, p->lLink);
...
{
    Insert(root, insertItem); //recursive insert
}
...
//Recursive Insert
template <class elemType>
void BST<elemType>::Insert(BSTNode*& current, elemType insertItem)
{
    if (current == nullptr)
    {
        current = new BSTNode;
    ...
    {
        Insert(current->lLink, insertItem);
    }
    else
    {
        Insert(current->rLink, insertItem);
    }
}
